...
$ambil = $conn->query("SELECT * FROM produk LEFT JOIN kategori ON produk.id_kategori=kategori.id_kategori WHERE id_produk='$id_produk'");
$detailproduk = $ambil->fetch_assoc();

$fotoproduk = array();
$ambilfoto = $conn->query("SELECT * FROM produk_foto WHERE id_produk='$id_produk'");
...
<div class="row">
  <?php foreach ($fotoproduk as $key => $value) : ?>
    <div class="col-md-4 text-center">
      <img src="../assets/img/<?= $value['nama_produk_foto']; ?>" alt="" class="img-responsive"><br>
...
if (isset($_POST['simpan'])) {
  ...
  $conn->query("INSERT INTO produk_foto(id_produk, nama_produk_foto) VALUES('$id_produk', '$namafoto')");
