...
if (isset($_POST["submit"])) {
	...
	move_uploaded_file($lokasilokasifoto[0], "../assets/img/" . $namanamafoto[0]);

	// menyimpan ke database
	$result = $conn->query("INSERT INTO produk VALUES('', '$_POST[id_kategori]', '$_POST[nama]', '$_POST[harga]', '$_POST[berat]', '$namanamafoto[0]', '$_POST[deskripsi]', '$_POST[stok]')");
	...
	foreach ($namanamafoto as $key => $tiap_nama) {
		...
		move_uploaded_file($tiap_lokasi, "../assets/img/" . $tiap_nama);

		// Memasukkan nama nama foto ke tabel produk_foto sesuai id_produk barusan
		$hasil = $conn->query("INSERT INTO produk_foto(id_produk, nama_produk_foto) VALUES('$id_produk_barusan','$tiap_nama')");
	}
